...
if (isset($_POST['upload'])){
  ...
  $sql = "UPDATE studentlist SET name='$text', department='$text1', company='$text2', image='$imgContent' WHERE id=$id";
    ...
    <div class="row">
      <div class="col-md-12 text-center ">
        ...
        <div class="over">
          ...
          <div class="label"><label for="">Update Student Details</label></div>
          ...
          <div class="input ">
            ...
            <input type="text" placeholder="Student Name" value="<?php echo $name?>" name="name" required>
          </div>

          <div class="input">
            <i class="fas fa-building"></i>
            <input type="text" placeholder="Department" value="<?php echo $dep?>" name="dep" required>
          </div>

          <div class="input ">
            <i class="fas fa-industry"></i>
            <input type="text" placeholder="Company" value="<?php echo $company?>" name="com" required>
          </div>
      ...
      <div class="container-fluid">
          <div class="row">
              <div class="col-md-2 col-4 side_bar " >
                  ...
                  <div class="items">
                    <a href=""><label style="color:grey;" for="">Udpate <i class="fas fa-chevron-right"></i></label></a>
                  </div>
                  ...
                  <div class="items">
                    <a href="message.php"><label for="">Messages <i class="fas fa-chevron-right"></i></label></a>
                  </div>
               </div>
               ...
               <div class="col-md-10 col-8">
                <div class="name" >
                  <label class="name1" for="">Update Student Info</label>
                  </div>
                         ...
                         while($row=mysqli_fetch_array($query_run)){
                           ?>
                            ...
                            <tr>
                              ...
                              <td><a href="update.php?edit=<?php echo $row['id']; ?>"  ><i onclick="near()" class="fas fa-pencil-alt icon" style="text-align:center;"></i></a></td>
                            </tr>
