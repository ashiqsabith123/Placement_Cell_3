      ...
      <div class="container-fluid">
          <div class="row">
              <div class="col-md-2 col-4 side_bar " >
                  <div class="items">
                      <a href="adminpanel.php"><label style="color:grey;" for="">Placed Students <i class="fas fa-chevron-right"></i></label></a>
                  </div>
            ...
            <div class="col-md-10 col-8" >
                ...
                <div class="name" >
                <label class="name1" for="">Placed Students</label>
                </div>
                           ...
                           while($row=mysqli_fetch_array($query_run)){
                             ?>
                              ...
                              <tr>
                                ...
                                <td class="col-1"> <?php echo '<img src="data:image;base64,'.base64_encode($row['image']).' " style="width:70px; height:100px;"> ' ?></td>
                              </tr>
